...
//		connection.close();
	...
	/* 2 */
	public List<Peca> consultaPecaPeloCodigo(String codigoLido) throws SQLException {
	...
	public List<Peca> consultaPecasPeloModelo(String modeloDoCarro) {
		...
		String sql = "SELECT p.* " + "FROM estoque.pecas p " + "WHERE ? IN (modelo_do_carro)";
